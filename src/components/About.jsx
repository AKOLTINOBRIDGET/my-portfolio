...
const About = () => {
  const stats = [
    ...
    { icon: <Palette className="h-6 w-6" />, value: "1+", label: "Years Experience", color: "from-purple-500 to-pink-500" },
    { icon: <Zap className="h-6 w-6" />, value: "3+", label: "Happy Clients", color: "from-orange-500 to-red-500" },
    { icon: <Award className="h-6 w-6" />, value: "2+", label: "Open Source", color: "from-green-500 to-emerald-500" },
  ];
